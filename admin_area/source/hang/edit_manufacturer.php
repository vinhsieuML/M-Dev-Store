...
<?php  
        ...
        if(isset($_GET['edit_manufacturer'])){
            ...
            $get_manufacturer = "select * from hang where id='$edit_manufacturer'";
            $run_manufacturer = mysqli_query($con,$get_manufacturer);
            $row_manufacturer = mysqli_fetch_array($run_manufacturer);

            $m_id = $row_manufacturer['id'];
            $m_title = $row_manufacturer['name'];
            $m_image = $row_manufacturer['image'];
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Cập Nhật Hãng
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        if(is_uploaded_file($_FILES['manufacturer_image']['tmp_name'])){
            ...
            $update_manufacturer = "update hang set name='$manufacturer_name',image='$manufacturer_image' where id='$m_id'" ;
            ...
            $update_manufacturer = "update hang set name='$manufacturer_name' where id='$m_id'" ;
